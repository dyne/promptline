...
Start with [local documentation](local-documentation.md), `caddy help`, `man 8 caddy`, the relevant subcommand page such as `man 8 caddy-reverse-proxy`, and `/usr/share/doc/caddy/README.Debian`. Only when those installed sources are insufficient, consult the authoritative online [Caddy reverse proxy](https://caddyserver.com/docs/caddyfile/directives/reverse_proxy), [command-line](https://caddyserver.com/docs/command-line), and [systemd service](https://caddyserver.com/docs/running) documentation; reconcile its syntax with `caddy version` and validate it locally before use.
